...
class TestFindSuccessor {
	...
	void test() throws InterruptedException, RemoteException {
		...
		BigInteger key1 = Hash.hashOf("file10"); // 73806995735690189889297542544385123161 | succ=process5
													// (121411138451101288395601026024677976156)
		BigInteger key2 = Hash.hashOf("file20"); // 127615430233524719490345743798572761786 | succ=process4
													// (210821560651360572675896360671414673172)
		BigInteger key3 = Hash.hashOf("file31"); // 83550242532527638904138483233262313637 | succ=process5
													// (121411138451101288395601026024677976156)
